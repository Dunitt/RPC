...
int main(){
	...
	cout << "*************************************************************************" << endl;
	cout << "testSUBTRACT: " << testSUBTRACT(2.34, 34.2) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testMULTIPLY: " << testMULTIPLY(3, 34) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testMULTIPLY: " << testMULTIPLY(2.34, 34.2) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testDIVISION: " << testDIVISION(0, 34) << endl;
	//cout << "*************************************************************************" << endl;
	//cout << "testDIVISION: " << testDIVISION(2, 0) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testPOW: " << testPOW(4.5, 2.0) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testSQRT: " << testSQRT(9.88) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testCOS: " << testCOS(22.67) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testSIN: " << testSIN(19.1) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testTAN: " << testTAN(3.9) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testATAN2: " << testATAN2(7.89, 5.16) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testACOS: " << testACOS(0.56) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testASIN: " << testASIN(0.1) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testATAN: " << testATAN(22.35) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testCOSH: " << testCOSH(72.5) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testSINH: " << testSINH(24.5) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testTANH: " << testTANH(28.32) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testCCOS: " << testCCOS(2.3, 8.55) << endl;
	cout << "*************************************************************************" << endl;
	cout << "testCSIN: " << testCSIN(5.6, 5.5) << endl;
	cout << "*************************************************************************" << endl;
